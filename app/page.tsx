...
// --- COMPONENT: SPOTLIGHT CARD (TECH UI) ---
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <span className="text-white/30 font-mono text-xs tracking-widest block mb-4">{venture.id}</span>
  ...
  return (
    <main className="bg-[#050505] min-h-screen text-[#ededed] selection:bg-[#D4AF37] selection:text-black font-sans overflow-x-hidden">
      ...
      >
        ...
        {/* --- INTERACTIVE ECOSYSTEM GRID (MAGNETIC SPOTLIGHT) --- */}
        <section className="py-32 px-6 md:px-20 bg-[#050505] relative border-t border-white/5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {VENTURES_DATA.map((venture) => (
              <SpotlightCard key={venture.id} venture={venture} />
            ))}
          </div>
        </section>
